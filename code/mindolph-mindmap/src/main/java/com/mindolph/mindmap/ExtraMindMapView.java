...
//                    generator.setParentSkin(parentSkin);
                        ...
                        generator.setOnGenerated(output -> {
                            ...
                            super.appendTextAsTopicTree(output.generatedText(), "sub-topics were generated by %s(%s) at %s".formatted(output.provider().getName(), output.model(), TimeUtils.createTimestamp()));
                        });
