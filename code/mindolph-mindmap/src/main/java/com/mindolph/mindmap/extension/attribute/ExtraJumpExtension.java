...
public class ExtraJumpExtension extends BaseTopicExtension {
    ...
    protected Text getIcon(ExtensionContext context, TopicNode activeTopic) {
        return FontIconManager.getIns().getIcon(IconKey.JUMP);
    }
    ...
    protected String getName(ExtensionContext context, TopicNode activeTopic) {
        ...
        return activeTopic.getExtras().containsKey(Extra.ExtraType.TOPIC) ? I18n.getIns().getString("MindMapPanel.menu.miEditTransition") :
                I18n.getIns().getString("MindMapPanel.menu.miAddTransition");
    }
