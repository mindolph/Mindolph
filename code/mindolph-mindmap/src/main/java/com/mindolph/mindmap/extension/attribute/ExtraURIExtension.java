...
public class ExtraURIExtension extends BaseTopicExtension {
    ...
    protected Text getIcon(ExtensionContext context, TopicNode activeTopic) {
        return FontIconManager.getIns().getIcon(IconKey.URI);
    }
    ...
    protected String getName(ExtensionContext context, TopicNode activeTopic) {
        ...
        return activeTopic.getExtras().containsKey(Extra.ExtraType.LINK) ? I18n.getIns().getString("MindMapPanel.menu.miEditURI") :
                I18n.getIns().getString("MindMapPanel.menu.miAddURI");
    }
