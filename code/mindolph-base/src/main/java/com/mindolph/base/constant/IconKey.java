...
public enum IconKey {
    ...
    RENAME, CLONE, DELETE, COLLAPSE_ALL, EXPAND_ALL, COLLAPSE_FOLDERS, MOVE_FOLDER,
    ALIGN, ALIGN_LEFT, ALIGN_RIGHT, ALIGN_CENTER,
    COPY, CUT, PASTE, WRAP,
    ADD_CHILD, // deprecated to PLUS
    ...
    H1, H2, H3, H4, H5, H6, COMMENT, BLOCK_COMMENT,
    GEN_AI, SHORT_TEXT, LONG_TEXT, SEND, STOP, TEMPERATURE, MAGIC,
    OUTLINE, OUTLINE_ITEM, SNIPPET,
    AT, ENTITY, SQUARE, HUMAN
}
