...
//        Assertions.assertEquals("### foobar", matcher.group("HB"));
    ...
    public static void main(String[] args) {
        String text = """
                ...
                - [FXFileChooser](https://oliver-loeffler.github.io/FXFileChooser/) - provides an alternative file chooser especially suitable for extreme large directories where an integrated live search and filtering can be helpful.\s
                ...
                - [ReactorFX](https://github.com/shadskii/ReactorFX) - ReactorFX integrates Project Reactor and JavaFX by providing a simple API to create reactive Flux from JavaFX Controls, Dialogs, Observables, and Collections.\s
                ...
                - [TiwulFX](https://bitbucket.org/panemu/tiwulfx) provides UI components: advanced TableView with various ready to use columns (TextColumn, NumberColumn, LookupColumn etc), DetachableTabPane that can be used as docking framework, MessageDialog, SideMenu etc.\s
                ...
                - [EasyFXML](https://github.com/Tristan971/EasyFXML) - EasyFXML is a fully-featured opinionated JavaFX framework based\s
                ...
                *Interesting talks in conferences like JavaOne, Devoxx and others*
                ...
                - [Enterprise JavaFX](https://www.youtube.com/watch?v=5yk6d8vjNE4) - by [Hendrik Ebbers](https://twitter.com/hendrikEbbers)<br/> The talks shows several APIs and technologies that useful to create JavaFX applications that communicate with a server
                ...
                *Interesting Articles about JavaFX*
                ...
                - [How JavaFX was used to build a desktop application](https://medium.com/techking/how-javafx-was-used-to-build-a-desktop-application-7d4c680d8dc) - A look at some of the features of JavaFX and how they were used in building an application.  The article includes links to all of the source code on GitHub.\s
                ...
                *Real World Examples of JavaFX and Applications*
                ...
                - [Mindolph](https://github.com/mindolph/Mindolph) - Mindolph is an open source personal knowledge management software for all desktop platforms. It is also a mind map editor, which is probably the best mind map tool developed by JavaFX.
                ...
                - [PacManFX](https://github.com/armin-reichert/pacman-javafx) - A JavaFX UI (2D + 3D) for Pac-Man and Ms. Pac-Man.\s
