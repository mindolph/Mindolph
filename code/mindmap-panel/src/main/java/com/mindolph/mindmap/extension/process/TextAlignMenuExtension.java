...
public class TextAlignMenuExtension extends BasePopupMenuItemExtension {
    ...
    public MenuItem makeMenuItem(ExtensionContext context, TopicNode activeTopic) {
        Menu result = new Menu(i18n.get("mindmap.menu.text.align"), FontIconManager.getIns().getIcon(IconKey.ALIGN));
        ...
        RadioMenuItem menuLeft = new RadioMenuItem(i18n.get("mindmap.menu.text.align.left"));
        RadioMenuItem menuCenter = new RadioMenuItem(i18n.get("mindmap.menu.text.align.center"));
        RadioMenuItem menuRight = new RadioMenuItem(i18n.get("mindmap.menu.text.align.right"));
