...
//  };
  ...
  public void testMindMapParse_Error_Empty() throws Exception {
    final MindMap map = new MindMap(new StringReader(""), TestTopicNode.testTopicCreator);
  }
  
  @Test(expected = IllegalArgumentException.class)
  public void testMindMapParse_Error_JustTextString() throws Exception {
    final MindMap map = new MindMap(new StringReader("Who is here"), TestTopicNode.testTopicCreator);
  }
  ...
  public void testIteration_TwoLevel() throws Exception {
    final MindMap<TestTopicNode> map = new MindMap<>(new StringReader("---\n# root\n## child1\n### child1.1\n### child1.2\n## child2\n### child2.1\n### child2.2\n"), TestTopicNode.testTopicCreator);
  ...
  public void testSerializableDeserializable_NoErrors() throws Exception {
    ...
    final MindMap<TestTopicNode> map = new MindMap();
