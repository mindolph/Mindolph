...
//  };
    ...
    public void testMindMapParse_Error_Empty() throws Exception {
        MindMap<TestTopicNode> map = new MindMap<>(new StringReader(""), TestTopicNode.testTopicCreator);
    }
    ...
    public void testFindNext_NonNull() throws Exception {
        ...
        TestTopicNode mars = map.findNext(null, earth, Pattern.compile(Pattern.quote("ar")), true, null);
    ...
    public void testFindPrev_NonNull() throws Exception {
        ...
        assertEquals("Mars", mars.getText());
        TestTopicNode earth = map.findPrev(null, mars, Pattern.compile(Pattern.quote("ar")), true, null);
        assertEquals("Earth", earth.getText());
        TestTopicNode solar = map.findPrev(null, earth, Pattern.compile(Pattern.quote("ar")), true, null);
    ...
    public void testIteration_OnlyRoot() throws Exception {
        ...
        assertArrayEquals(new String[]{"root"}, list.toArray(new String[0]));
    }
