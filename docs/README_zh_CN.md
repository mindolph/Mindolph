...
|macOS|.dmg|[v1.7.7](https://github.com/mindolph/Mindolph/releases/download/v1.7.7/Mindolph-1.7.7-aarch64.dmg) |[v1.8.1](https://github.com/mindolph/Mindolph/releases/download/v1.8.1/Mindolph-1.8.1-aarch64.dmg) | Apple Silicon </br>显示 PlantUML 图需要先安装 graphviz:</br>`brew install graphviz`|
...
|Debian|.deb|[v1.7.7](https://github.com/mindolph/Mindolph/releases/download/v1.7.7/Mindolph-1.7.7.deb)|[v1.8.1](https://github.com/mindolph/Mindolph/releases/download/v1.8.1/Mindolph-1.8.1.deb)|	显示 PlantUML 图需要先安装 graphviz:  </br>  `sudo apt install graphviz`|
