...
|macOS|.dmg|[v1.8.4](https://github.com/mindolph/Mindolph/releases/download/v1.8.4/Mindolph-1.8.4-aarch64.dmg) |[v1.9.1](https://github.com/mindolph/Mindolph/releases/download/v1.9.1/Mindolph-1.9.1-aarch64.dmg) | Apple Silicon </br>显示 PlantUML 图需要先安装 graphviz:</br>`brew install graphviz`|
...
|Debian|.deb|[v1.8.4](https://github.com/mindolph/Mindolph/releases/download/v1.8.4/Mindolph-1.8.4.deb)|[v1.9.1](https://github.com/mindolph/Mindolph/releases/download/v1.9.1/Mindolph-1.9.1.deb)|	显示 PlantUML 图需要先安装 graphviz:  </br>  `sudo apt install graphviz`|
