...
|系统|类型|稳定版|不稳定版|备注|
|----|----|----|----|----|
|macOS|.dmg|[v1.13.6](https://github.com/mindolph/Mindolph/releases/download/v1.13.6/Mindolph-1.13.6-aarch64.dmg) |[v1.14.3](https://github.com/mindolph/Mindolph/releases/download/v1.14.3/Mindolph-1.14.3-aarch64.dmg) | Apple Silicon </br>显示 PlantUML 图需要先安装 graphviz:</br>`brew install graphviz`|
...
|Debian/Ubuntu|.deb|[v1.13.6](https://github.com/mindolph/Mindolph/releases/download/v1.13.6/Mindolph-1.13.6.deb)|[v1.14.3](https://github.com/mindolph/Mindolph/releases/download/v1.14.3/Mindolph-1.14.3.deb)|	显示 PlantUML 图需要先安装 graphviz:  </br>  `sudo apt install graphviz`|
...
|Java Executable|.jar|[v1.13.6](https://github.com/mindolph/Mindolph/releases/download/v1.13.6/Mindolph-1.13.6.jar)|[v1.14.3](https://github.com/mindolph/Mindolph/releases/download/v1.14.3/Mindolph-1.14.3.jar)| 请看 [如何运行](./INSTALL_zh_CN.md) |
