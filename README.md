...
|macOS|.dmg|[v1.11.9](https://github.com/mindolph/Mindolph/releases/download/v1.11.9/Mindolph-1.11.9-aarch64.dmg) |[v1.12.2](https://github.com/mindolph/Mindolph/releases/download/v1.12.2/Mindolph-1.12.2-aarch64.dmg) | Apple Silicon </br>for supporting PlantUML, install graphviz first:</br>`brew install graphviz`|
...
|Debian/Ubuntu|.deb|[v1.11.9](https://github.com/mindolph/Mindolph/releases/download/v1.11.9/Mindolph-1.11.9.deb)|[v1.12.2](https://github.com/mindolph/Mindolph/releases/download/v1.12.2/Mindolph-1.12.2.deb)|	for supporting PlantUML, install graphviz first:</br>  `sudo apt install graphviz`|
