...
|----|----|----|----|----|
|macOS|.dmg|[v1.11.8](https://github.com/mindolph/Mindolph/releases/download/v1.11.8/Mindolph-1.11.8-x64.dmg) |[v1.12.0](https://github.com/mindolph/Mindolph/releases/download/v1.12.0/Mindolph-1.12.0-x64.dmg) | Intel |
|macOS|.dmg|[v1.11.8](https://github.com/mindolph/Mindolph/releases/download/v1.11.8/Mindolph-1.11.8-aarch64.dmg) |[v1.12.0](https://github.com/mindolph/Mindolph/releases/download/v1.12.0/Mindolph-1.12.0-aarch64.dmg) | Apple Silicon </br>for supporting PlantUML, install graphviz first:</br>`brew install graphviz`|
|Windows|.msi|[v1.11.8](https://github.com/mindolph/Mindolph/releases/download/v1.11.8/Mindolph-1.11.8.msi) |[v1.12.0](https://github.com/mindolph/Mindolph/releases/download/v1.12.0/Mindolph-1.12.0.msi) | |
|Debian/Ubuntu|.deb|[v1.11.8](https://github.com/mindolph/Mindolph/releases/download/v1.11.8/Mindolph-1.11.8.deb)|[v1.12.0](https://github.com/mindolph/Mindolph/releases/download/v1.12.0/Mindolph-1.12.0.deb)|	for supporting PlantUML, install graphviz first:</br>  `sudo apt install graphviz`|
|Fedora|.rpm|[v1.11.8](https://github.com/mindolph/Mindolph/releases/download/v1.11.8/Mindolph-1.11.8.rpm)|[v1.12.0](https://github.com/mindolph/Mindolph/releases/download/v1.12.0/Mindolph-1.12.0.rpm)| |
|Java Executable|.jar|[v1.11.8](https://github.com/mindolph/Mindolph/releases/download/v1.11.8/Mindolph-1.11.8.jar)|[v1.12.0](https://github.com/mindolph/Mindolph/releases/download/v1.12.0/Mindolph-1.12.0.jar)| Java 21 is the minimum version to run this application. 	</br> If you are using Linux, run the jar like this:  </br> `java -jar Mindolph-1.11.8.jar`  </br> If not, download latest JavaFX SDK for your platform and extract to somewhere eg: `c:\javafx-sdk-23`, run the jar file like this:   </br> `java --module-path c:\javafx-sdk-23\lib --add-modules  java.sql,javafx.controls,javafx.fxml,javafx.swing,javafx.web,jdk.crypto.ec -jar  Mindolph-1.11.8.jar` |
